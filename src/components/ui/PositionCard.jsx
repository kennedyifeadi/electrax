...
export const PositionCard = ({Position, Team, Location, workTime}) => {
  return (
    <div className='w-[60%] h-[100px] px-10 flex border border-[#8080802f] hover:border-[gray] bg-transparent hover:bg-[#80808009] rounded-2xl duration-300 ease-in-out cursor-pointer ' style={{fontFamily:" 'Inter', sans-serif"}}>
        <div className='w-[80%] h-full flex flex-col justify-center items-center gap-2'>
            <div className='w-full flex flex-col md:flex-row h-[50%] items-center justify-end md:justify-start md:items-end gap-4'>
