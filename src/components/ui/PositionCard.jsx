...
export const PositionCard = ({Position, Team, Location, workTime}) => {
  return (
    <div className='w-[100%] h-[8rem] md:px-10 px-6 flex border border-[#8080802f] hover:border-[gray] bg-transparent hover:bg-[#0c090928] rounded-2xl duration-300 ease-in-out cursor-pointer ' style={{fontFamily:" 'Inter', sans-serif"}}>
        <div className='w-[80%] h-full flex flex-col justify-center items-center gap-2'>
            <div className='w-full flex flex-col-reverse md:flex-row h-fit justify-start md:justify-start md:items-end gap-4'>
